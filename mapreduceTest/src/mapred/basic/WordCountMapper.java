...
//										--------
//	* Context :	- 맵리듀스 작업을 수행하며 맵메소드의 실행결과 즉, 출력데이터를 기록하고 shuffle하고 리듀서로
//				내보내는 작업을 수행하는 객체
//				- 프레임워크 내부에서 기본작업을 처리하는 객체, 내부에서 머신들끼리 통신할 때 필요한 여러가지 정보를 갖고 있다.
public class WordCountMapper 
	extends Mapper<LongWritable, Text, Text, IntWritable>{
	//output데이터를 mapper에 실행결과로 내보낼 수 있도록 키와 value를 저장하는 변수
